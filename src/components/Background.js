    ...
    <div className="bg-light py-5 mb-5">
        <div className="col-md-6 col-lg-4 mx-auto">
            ...
            <p>
                ...
                let me see how many improvements there were to be made in the
                tech and process.
            </p>
            <p>
                ...
                management process. I built the first version of Electask and
                had them try it out.
            </p>
            <p>
                After a few tweaks, they were up and running with it and
                implemented it into their core task management process. Now,
                several improvements later (and more to come), Sacramento, along
                with other counties, have found value in what Electask can do.
            </p>
            <p>
                The bottom line is it makes their life easier. It helps everyone
                stay up to date and on the same page. And many more exciting
                features and improvements are scheduled for the future.
            </p>
        </div>
    </div>
);
